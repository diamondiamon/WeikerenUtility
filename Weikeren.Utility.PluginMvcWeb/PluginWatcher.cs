namespace Weikeren.Utility.PluginMvcWeb
{
    ...
    public static class PluginWatcher
    {
        ...
        {
            //LogHelper.Instance.Debug(message);
        }
    }
}